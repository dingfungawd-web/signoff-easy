            ...
            <div className="border border-t-0 border-border rounded-b-md p-4 space-y-3">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 border-b border-border bg-transparent pt-1 pb-2 px-2 leading-normal focus:outline-none focus:border-primary"
                  placeholder="請輸入地址"
                />
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <div className="flex items-center gap-1">
                  <input value={installDate.year} onChange={(e) => setInstallDate({ ...installDate, year: e.target.value })} className="w-16 border-b border-border bg-transparent pt-1 pb-2 px-1 leading-normal text-center focus:outline-none focus:border-primary" placeholder="年" />
                  <span>年</span>
                  <input value={installDate.month} onChange={(e) => setInstallDate({ ...installDate, month: e.target.value })} className="w-12 border-b border-border bg-transparent pt-1 pb-2 px-1 leading-normal text-center focus:outline-none focus:border-primary" placeholder="月" />
                  <span>月</span>
                  <input value={installDate.day} onChange={(e) => setInstallDate({ ...installDate, day: e.target.value })} className="w-12 border-b border-border bg-transparent pt-1 pb-2 px-1 leading-normal text-center focus:outline-none focus:border-primary" placeholder="日" />
                  <span>日</span>
                </div>
              </div>
            </div>
              ...
              <div className="border-t border-border pt-3 space-y-3">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 border-b border-border bg-transparent pt-1 pb-2 px-2 leading-normal text-sm focus:outline-none focus:border-primary"
                    placeholder="請輸入客戶姓名"
                  />
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <input value={signDate.day} onChange={(e) => setSignDate({ ...signDate, day: e.target.value })} className="w-12 border-b border-border bg-transparent pt-1 pb-2 px-1 leading-normal text-center text-sm focus:outline-none focus:border-primary" placeholder="日" />
